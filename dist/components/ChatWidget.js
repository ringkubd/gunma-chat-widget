...
export function ChatWidget(config) {
    const { isOpen, isLoading, messages, error, toolStatus, isAiEnabled, toggle, sendMessage, endChat, cancelRequest, } = useChat(config);
