...
export function CommercePanel({ commerce, brandColor, onClose, strings }) {
    ...
    return (_jsxs("div", { className: "gunma-commerce", children: [header, _jsx("div", { className: "gunma-commerce-section", children: cart.length === 0 ? (_jsx("p", { className: "gunma-commerce-muted", children: s.cartEmpty })) : (_jsxs(_Fragment, { children: [hasStockIssues && (_jsxs("div", { className: "gunma-commerce-stock-warning", children: [_jsxs("strong", { children: ["\u26A0\uFE0F ", s.stockIssueTitle] }), _jsx("ul", { children: stockIssues.map((iss) => (_jsx("li", { children: _jsxs("span", { className: "gunma-commerce-stock-line", children: [_jsxs("span", { children: [iss.title, " \u2014 ", s.stockReason(iss.reason), iss.reason === 'insufficient' && iss.available !== null
                        ...
                        }), _jsxs("div", { className: "gunma-commerce-total-row", children: [_jsx("span", { children: s.subtotal }), _jsx("span", { children: money(symbol, subtotal) })] }), _jsxs("div", { className: "gunma-commerce-total-row", children: [_jsx("span", { children: s.tax }), _jsx("span", { children: money(symbol, totalTax) })] }), _jsxs("div", { className: "gunma-commerce-total-row", children: [_jsx("span", { children: s.shipping }), _jsx("span", { children: shippingCharge === 0 ? s.free : money(symbol, shippingCharge) })] }), _jsxs("div", { className: "gunma-commerce-total-row gunma-commerce-grand", children: [_jsx("span", { children: s.total }), _jsx("strong", { children: money(symbol, subtotal + totalTax + shippingCharge) })] }), subtotal < commerce.freeShippingThreshold && (_jsx("p", { className: "gunma-commerce-muted", children: s.freeShipHint(money(symbol, commerce.freeShippingThreshold - subtotal)) })), _jsx("button", { className: "gunma-commerce-primary", style: { backgroundColor: brandColor }, disabled: loading || hasStockIssues, onClick: () => startCheckout(), children: loading ? 'Please wait…' : s.checkout }), errorMessage && _jsx("p", { className: "gunma-commerce-error", children: errorMessage })] })) })] }));
}
